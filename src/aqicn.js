    ...
    try{
      ...
      googleMapsClient.geocode({
        ...
        if (!err) {
          ...
          const weatherUrl = `https://api.waqi.info/feed/geo:${geo.geometry.location.lat};${geo.geometry.location.lng}/?token=${AQICN_TOKEN}`;
          ...
          request(weatherUrl,
            (error, response, body)=>{
              ...
              +`PM 2.5: ${jsonObj.data.iaqi.pm25.v || "자료 없음"}, PM 10: ${jsonObj.data.iaqi.pm10.v || "자료 없음"}\n`
